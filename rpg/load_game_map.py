...
def load_map(map_name):
    ...
    layer_options = {
        "trees_blocking": {"use_spatial_hash": True},
        "misc_blocking": {"use_spatial_hash": True},
        "bridges": {"use_spatial_hash": True},
        "water_blocking": {"use_spatial_hash": True},
    }
    ...
    if "lights" in my_map.object_lists:
        ...
        # Hack: Add default light if no lights are found
        x, y, radius, mode, color = 0, 0, 1, "soft", arcade.csscolor.WHITE
    ...
    # Add wall list for blocking layers
